...
//                        /fragment.glsl
//
// Uniforms are values that are same for every vertex
...
// from the vertex shader is using varying which we showed in
// previous lesson
// WELL, UNIFORM IS AUTOMATICALLY PASSED TO BOTH VERTEX AND
// FRAGMENT SHADER
  ...
  const material = new THREE.RawShaderMaterial({
    ...
    uniforms: {
      uFrequency: {
        ...
        // since we didn't define value as a float 10.0
        // (which we clould but we choosen not to
