...
// in vertex shader we will create new varying called
// vElevation so we would be allowed to use that value
// inside fragment shader where we will based on that
// elevation to some interpolation
